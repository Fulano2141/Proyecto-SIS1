...
class addevulu extends StatefulWidget{
  const addevulu({
    Key key,
...
class _listaprod extends State<addevulu>{
                ...
                return Column(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child:  Card(
                        color: Colors.white,
                        child: '${pedi[position].estado}' == 'pendiente'?
                        Row(
                          children: <Widget>[
                            new Container(
                            ...
                            IconButton(
                              ...
                              onPressed:(){
                                _actualisar('${pedi[position].id}','aceptado');
                              },
                            ),
                            IconButton(
                              icon: Icon(
                              ...
                              onPressed:(){
                                _actualisar('${pedi[position].id}','rechazado');
                              },
                            ),
  ...
  _actualisar(String a ,String b){
    databaseReference.child(a).update({
      'estado': b,
    });
  }
